...
function Newsletter() {
  ...
  <div className="flex gap-5 justify-center mb-4">
    ...
    />
    <button className="px-6 py-3 rounded-2xl hover:scale-95 duration-300 transition text-white bg-gradient-to-r from-yellow-400  to-yellow-500 hover:bg-gradient-to-br focus:ring-4 shadow-xl font-medium">
      Subscribe{" "}
    </button>
  </div>
</form> 
